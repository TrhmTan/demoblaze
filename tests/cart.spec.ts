...
test.describe('CartPage Test Suite', () => {
    ...
    // TC-CRT-020: Place Order with invalid credit card number (non-numeric)
    // Demoblaze lacks backend validation on card formatting. Accepts non-numeric characters.
    test('TC-CRT-020: Place Order with invalid credit card number (non-numeric)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        await cartPage.openPlaceOrderModal();
        ...
        await cartPage.clickPurchase();
        const successText = await cartPage.confirmSuccessPurchase();
        expect(successText).toContain('Card Number: ABCD-EFGH');
    });
    ...
    test('TC-CRT-027: Credit card - 17 digits (exceeds max)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        ...
        expect(successText).toContain('Card Number: 41111111111111111');
    });

    // TC-CRT-028: Credit card - all zeros
    test('TC-CRT-028: Credit card - all zeros', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
        ...
        expect(successText).toContain('Card Number: 0000000000000000');
    });

    // TC-CRT-029: Credit card - contains spaces
    test('TC-CRT-029: Credit card - contains spaces', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-030: Credit card - Luhn checksum invalid', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
        ...
        expect(successText).toContain('Card Number: 4111111111111112');
    });

    // TC-CRT-031: Month - 0 (invalid)
    test('TC-CRT-031: Month - 0 (invalid)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-032: Month - 13 (exceeds range)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-033: Month - non-numeric characters', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-035: Year - 2-digit input (25 instead of 2025)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-036: Year - past year (2024, expired)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-037: Year - far future (2100+)', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
    ...
    test('TC-CRT-038: Year - non-numeric characters', async ({ page }) => {
        const cartPage = new CartPage(page);
        await cartPage.addProductToCart('Phones', 'Samsung galaxy s6');
        await cartPage.navigateToCart();
        const successText = await cartPage.placeOrderAndGetInvoice({
