...
This is a local workflow, not a CI-managed one: the GitHub Actions workflow (`.github/workflows/playwright.yml`) runs Login/Cart/API and uploads the HTML report as a downloadable build artifact - it does not write anything back into this folder.
